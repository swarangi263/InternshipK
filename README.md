...
🚀 **A responsive and interactive website developed during my internship, showcasing KPIN as a modern link-in-bio platform.**
...
- **assets/**: Media files, fonts, scripts, and stylesheets  
  - **css/**: Bootstrap, Maicons, and custom styles (mobster.css)  
...
- **Maicons:** Icon fonts for UI elements  
